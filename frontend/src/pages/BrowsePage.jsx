...
function BrowsePage() {
    ...
    const [loading, setLoading] = useState(true); // Page's main data loading state
    ...
    // Get loadingViewed separately, but we won't combine it for the grid's loading prop initially
    ...
    // Effect to check for 'openMemeId' (Unchanged)
    ...
    return (
        <div className="browse-page">
            ...
            <MemeGrid
                memes={memes}
                // *** TEMPORARILY SIMPLIFIED LOADING PROP ***
                loading={loading} // Use only the page's loading state for now
                error={null}
                onMemeClick={openModal}
                onVote={handleVote} // Still pass vote handler
                onFavoriteToggle={handleFavoriteToggle}
                 // Still pass the check function, but loading only depends on page data now
